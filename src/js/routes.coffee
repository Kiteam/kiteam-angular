...
define [
  ...
  "./app"
  './utils'
  './issue/views/issue-all.html'
  './member/views/member-all.html'
  './commit/views/commit-all.html'
  './assets/views/assets-all.html'
  './project/views/project-all.html'
  './report/views/report-all.html'
  './global-directives/views/global-all.html'
  './member/views/authority.html'
  './views/wiki-all.html'
  './team/views/team-all.html'
  './stream/views/stream-all.html'
  './gitlab/views/gitlab.html',
  ...
  ($routeProvider, $locationProvider, $stateProvider, $urlRouterProvider) ->
    ...
    templates =
      issueDetails: require('./issue/views/details.html')
